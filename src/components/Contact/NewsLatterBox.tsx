    ...
    <div className="shadow-three dark:bg-gray-dark relative z-10 rounded-lg bg-white p-8 sm:p-11 lg:p-8 xl:p-11">
      ...
      <div>
        <input
          ...
          className="border-stroke text-body-color focus:border-primary dark:text-body-color-dark dark:shadow-two dark:focus:border-primary mb-4 w-full rounded-lg border bg-[#f8f8f8] px-6 py-3 text-base outline-hidden dark:border-transparent dark:bg-[#2C303B] dark:focus:shadow-none"
        />
        <input
          type="email"
          name="email"
        ...
        <input
          type="submit"
          value={t("contact.newsletter_button")}
          className="bg-primary shadow-submit hover:bg-primary/90 dark:shadow-submit-dark mb-5 flex w-full cursor-pointer items-center justify-center rounded-lg px-9 py-4 text-base font-medium text-white duration-300"
        />
        <p className="text-body-color dark:text-body-color-dark text-center text-base leading-relaxed">
          {t("contact.newsletter_no_spam")}
        </p>
      </div>
